...
local M = require("core.variables")
local mainMod = M.mod
...
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd(M.terminal))
local closeWindowBind = hl.bind(mainMod .. " + Q", hl.dsp.window.close())
-- closeWindowBind:set_enabled(false)
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(M.fileManager))
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(M.browser))
hl.bind(mainMod .. " + H", hl.dsp.exec_cmd(M.editor))
hl.bind(mainMod .. " + V", hl.dsp.window.float({ action = "toggle" }))
hl.bind(mainMod .. " + SPACE", hl.dsp.exec_cmd(M.menu))
